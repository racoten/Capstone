...
void SHELLCODE(ApiReeKall * ark){
	size_t ret = (size_t) ark->ARK_func(ark->param1, ark->param2, ark->param3, ark->param4);
	ark->retval = ret;
...
int main(void){
	...
	ApiReeKall ark = { 0 };
	ark.ARK_func = (MessageBox_t) GetProcAddress(LoadLibrary("user32.dll"), "MessageBoxA");
	ark.param1 = NULL;
	strcpy_s(ark.param2, 50, "RtlRemoteCall, baby!");
	strcpy_s(ark.param3, 50, "RTO");
	ark.param4 = MB_OK;	
