...
We can now use the Header library to perform RDI

We add the header file
```c
#include "ReflectiveLoader.h"
```

We export our DllMain function to execute on DLL load
```c
...
This will then run a thread and call the Go function
```c
